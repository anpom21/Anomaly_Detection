...
def plot_light_positions(T, center, light_radius, light_height, n_light):
        ...
        ax.scatter(x_coords, y_coords, z_coords, c='yellow', marker='o', s=100, label='Light Sources')
        ...
        ax.plot_surface(x_cylinder, y_cylinder, z_cylinder, color='blue', alpha=0.3)
