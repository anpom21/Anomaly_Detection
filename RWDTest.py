...
if __name__ == "__main__":
    ...
    for model_name in models:
        ...
        # Train the model
        modelName =f"{model_name}RW_{i}"
        #Trainer.train_model(model=model, train_loader=train_loader, val_loader=val_loader, num_epochs=200, lr=0.001, save_path=f"models/Trained_models/RW_Test/IRL_3_channel/{model_name}_{i}.pth", patience=40, FigSavePath=Fig_SavePath, ModelName=modelName, display=display)
    ...
    plt.bar(df["Model"], df["Accuracy"], color='blue', alpha=0.7, label='Accuracy')
